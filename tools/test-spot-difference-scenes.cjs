...
function harness(level){let now=10000,id=0,url='';const tasks=new Map(),life={},storage=new Map();
...
console.log('PASS: legacy pixel checks; 500 story recipes with exact 2–5 swaps; full sessions/scoring/pause; pair-ready/stale/duplicate/error/timeout/retry callbacks; display-only history and stable recipe keys');
